...
<body>
	...
	<div class="section sTop">
		...
		<div class="inner">
			<h1>Sharp Theme - Free Q2A Theme </h1>
			<p>Created & Documentation by &ldquo;<a href="http://towhidn.com/" style="color: rgb(34, 34, 136);">Towhid</a>&rdquo;  -  v1.2.0  - Provided by <a href="http://QA-Themes.com/" style="color: rgb(34, 34, 136);">Q2A Themes</a></p>
			<small>v2.0.0</small>
		</div>
		<br class="clear">
	</div>
	...
	<div class="section s1">
		...
		<div class="inner">
			...
			<ol>
				<li><p>Extract <strong>Sharp-theme.zip</strong>.</p></li>
				<li>upload Content of <strong>Sharp-theme</strong> directory to <strong>qa-themes/</strong> directory in your Q2A site</li>
				<li><p>Log in as Administrator, then Go to <strong>Admin &gt; General</strong> and select 'Sharp-Theme' as your default theme.</p></li>
			...
			<h3>It should look like <a href="http://demo.qa-themes.com/Sharp/">demo</a> Now</h3>
		</div>
	</div>

	<div class="section s2">
		<div class="inner">
			<p><strong>Sharp Theme</strong> offers a wide range of customizations that you can easily apply on your theme.</p>
			...
			<ol>
				...
				<li><strong>Social Links:</strong> Add social links to your Navigation bar</li>
			</ol>			
		</div>
	...
	<div class="section s3">
		...
		<p>you have more backgrounds that you want to try on your theme? simply save them as .png files and upload the file in 'qa-themes/Sharp-theme/patterns' and it will be added to backgrounds list.</p>
		...
		<p>to add a new CSS file you can upload it in 'qa-themes/Sharp-theme/styles' or you can edit one of pre-made styles.</p>
		</div>
	...
	<div class="section s5">
		...
		<ul>
			...
			<li><a target="_blank" href="http://codepen.io/daless14/pen/Cbqxf">social sharing Links</a> Used in Nav-Bar</li>
			<li><a target="_blank" href="http://codepen.io/jackrugile/pen/ABeIi">Search Bar</a> CSS Styling</li>
			<li><a target="_blank" href="http://webdesignerwall.com/tutorials/animated-scroll-to-top">scroll</a> for Scroll to Top</li>
