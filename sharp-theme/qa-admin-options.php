	...
	function doctype(){
		...
		if ( ($qa_request == 'admin/theme_options') and (qa_get_logged_in_level()>=QA_USER_LEVEL_ADMIN) ) {
			...
			if (qa_clicked('qat_save_button')) {
				...
				qa_opt('qat_social_twitter', qa_post_text('qat_social_twitter_field'));
				qa_opt('qat_social_fb', qa_post_text('qat_social_fb_field'));
				qa_opt('qat_social_youtube', qa_post_text('qat_social_youtube_field'));
				qa_opt('qat_social_linkedin', qa_post_text('qat_social_linkedin_field'));
				qa_opt('qat_social_blog', qa_post_text('qat_social_blog_field'));
				qa_opt('qat_social_flicker', qa_post_text('qat_social_flicker_field'));
				qa_opt('qat_social_feed', qa_post_text('qat_social_feed_field'));
			...
			// Option Form
			$options= array(
				'ok' => $saved ? 'sharp settings saved' : null,
				...
				'fields' => array(
					...
					array(
						'type' => 'static',
						'label' => '<span class="qa-option-header"> Social links </span>',
					),
					array(
						'label' => 'Twitter profile link',
						'tags' => 'NAME="qat_social_twitter_field" ID="qat_social_twitter_field"',
						'value' => qa_opt('qat_social_twitter'),
						),
					array(
						'label' => 'Facebook profile link:',
						'tags' => 'NAME="qat_social_fb_field" ID="qat_social_fb_field"',
						'value' => qa_opt('qat_social_fb'),
						),
					array(
						'label' => 'Youtube profile link:',
						'tags' => 'NAME="qat_social_youtube_field" ID="qat_social_youtube_field"',
						'value' => qa_opt('qat_social_youtube'),
						),
					array(
						'label' => 'LinkedIn profile link:',
						'tags' => 'NAME="qat_social_linkedin_field" ID="qat_social_linkedin_field"',
						'value' => qa_opt('qat_social_linkedin'),
						),
					array(
						'label' => 'Blog URL:',
						'tags' => 'NAME="qat_social_blog_field" ID="qat_social_blog_field"',
						'value' => qa_opt('qat_social_blog'),
						),
					array(
						'label' => 'Flicker URL:',
						'tags' => 'NAME="qat_social_flicker_field" ID="qat_social_flicker_field"',
						'value' => qa_opt('qat_social_flicker'),
						),
					array(
						'label' => 'RSS Feed URL:',
						'tags' => 'NAME="qat_social_feed_field" ID="qat_social_feed_field"',
						'value' => qa_opt('qat_social_feed'),
						),
					array(
						'type' => 'blank',
					),
					array(
						'type' => 'static',
						'label' => '<span class="qa-option-header"> CSS Stlyling </span>',
					),
					array(
